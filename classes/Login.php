...
class Login
{
    ...
    /** @var string $user_image_url The user's profile pic url (or a default one) */
    public $user_image_url = "";

    public $user_points = "";
	
	public $max_points_reached="";
    ...
    private function getUserData($user_name)
    {
        ...
        if ($this->databaseConnection()) {
            ...
            $query_user = $this->db_connection->prepare('SELECT * FROM users WHERE user_name = :user_name OR user_email=:user_name');
    ...
    private function loginWithSessionData()
    {
        ...
        $this->user_fullname = $_SESSION['user_fullname'];
        $this->user_email = $_SESSION['user_email'];
        $this->user_id = $_SESSION['user_id'];
        $this->user_points = $_SESSION['user_points'];
            ...
            if ($hash == hash('sha256', $user_id . ':' . $token . COOKIE_SECRET_KEY) && !empty($token)) {
                ...
                if ($this->databaseConnection()) {
                    ...
                    if (isset($result_row->user_id)) {
                        ...
                        $this->user_rank = $result_row->user_rank;
                        $this->user_email = $result_row->user_email;
                        $this->user_points = $result_row->user_points;
                        ...
                        return true;
                            ...
                            $this->messages[] = "Wrong username/password";
					}
                }
            }
